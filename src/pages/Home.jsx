      ...
      <section className="bg-white dark:bg-zinc-900 py-24 px-6 border-y border-gray-100 dark:border-zinc-800 transition-colors duration-500">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl space-y-4">
            <h2 className="text-3xl font-bold dark:text-white">Why choose {APP_NAME}?</h2>
            <p className="text-gray-600 dark:text-zinc-400">
              We combine unmatched operational efficiency with a customer-first approach. From 24x7 assistance to GPS enabled fleets, we ensure your journey is seamless and safe.
            </p>
          </div>
